...
from .views import PostCreateView, PostDetailView, PostUpdateView, CommentCreateView, LikeCreateView


# Список маршрутов. post-create создание поста. post-detail получение деталей поста.
